...
class SplTokenBonding extends spl_utils_1.AnchorSdk {
     ...
     * @returns
     */
    createTokenBondingInstructions({ generalAuthority = this.wallet.publicKey, curveAuthority = null, reserveAuthority = null, payer = this.wallet.publicKey, curve, baseMint, targetMint, buyBaseRoyalties, buyBaseRoyaltiesOwner = this.wallet.publicKey, buyTargetRoyalties, buyTargetRoyaltiesOwner = this.wallet.publicKey, sellBaseRoyalties, sellBaseRoyaltiesOwner = this.wallet.publicKey, sellTargetRoyalties, sellTargetRoyaltiesOwner = this.wallet.publicKey, buyBaseRoyaltyPercentage, buyTargetRoyaltyPercentage, sellBaseRoyaltyPercentage, sellTargetRoyaltyPercentage, mintCap, purchaseCap, goLiveDate = new Date(new Date().valueOf() - 10000), // 10 secs ago
    ...
    updateTokenBondingInstructions({ tokenBonding, buyBaseRoyaltyPercentage, buyTargetRoyaltyPercentage, sellBaseRoyaltyPercentage, sellTargetRoyaltyPercentage, buyBaseRoyalties, buyTargetRoyalties, sellBaseRoyalties, sellTargetRoyalties, generalAuthority, reserveAuthority, buyFrozen, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (generalChanges) {
                ...
                const args = {
                    buyBaseRoyaltyPercentage: (0, spl_utils_1.percent)(buyBaseRoyaltyPercentage) ||
                        tokenBondingAcct.buyBaseRoyaltyPercentage,
                    buyTargetRoyaltyPercentage: (0, spl_utils_1.percent)(buyTargetRoyaltyPercentage) ||
                        tokenBondingAcct.buyTargetRoyaltyPercentage,
                    sellBaseRoyaltyPercentage: (0, spl_utils_1.percent)(sellBaseRoyaltyPercentage) ||
                        tokenBondingAcct.sellBaseRoyaltyPercentage,
                    sellTargetRoyaltyPercentage: (0, spl_utils_1.percent)(sellTargetRoyaltyPercentage) ||
    ...
    buyBondingWrappedSolInstructions({ payer = this.wallet.publicKey, destination, source = this.wallet.publicKey, amount, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let usedAta = false;
            if (!destination) {
                destination = yield spl_token_1.Token.getAssociatedTokenAddress(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, state.wrappedSolMint, source);
                usedAta = true;
            }
            const instructions = [];
    ...
    sellBondingWrappedSolInstructions({ source, owner = this.wallet.publicKey, destination = this.wallet.publicKey, amount, all = false, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const mint = yield (0, spl_utils_1.getMintInfo)(this.provider, state.wrappedSolMint);
            if (!source) {
                source = yield spl_token_1.Token.getAssociatedTokenAddress(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, state.wrappedSolMint, owner);
            }
            const instructions = [];
    ...
    buyInstructions({ tokenBonding, source, sourceAuthority = this.wallet.publicKey, destination, desiredTargetAmount, baseAmount, expectedOutputAmount, expectedBaseAmount, slippage, payer = this.wallet.publicKey, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const signers = [];
            if (!destination) {
                destination = yield spl_token_1.Token.getAssociatedTokenAddress(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, tokenBondingAcct.targetMint, sourceAuthority);
            ...
            if (!source) {
                if (isNative) {
                    ...
                    source = yield spl_token_1.Token.getAssociatedTokenAddress(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, tokenBondingAcct.baseMint, sourceAuthority);
     ...
     * @param param0
     */
    swap({ payer = this.wallet.publicKey, sourceAuthority = this.wallet.publicKey, baseMint, targetMint, baseAmount, expectedBaseAmount, desiredTargetAmount, expectedOutputAmount, slippage, extraInstructions = () => Promise.resolve({
        instructions: [],
        signers: [],
        output: null,
    }), }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let currAmount = (0, utils_1.toBN)(baseAmount, baseMintInfo);
            ...
            for (const [index, subHierarchy] of hierarchyToTraverse.entries()) {
                ...
                const ata = yield spl_token_1.Token.getAssociatedTokenAddress(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, isBuy ? tokenBonding.targetMint : tokenBonding.baseMint, sourceAuthority);
    ...
    sellInstructions({ tokenBonding, source, sourceAuthority = this.wallet.publicKey, destination, targetAmount, expectedOutputAmount, slippage, payer = this.wallet.publicKey, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const instructions = [];
            if (!source) {
                source = yield spl_token_1.Token.getAssociatedTokenAddress(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, tokenBondingAcct.targetMint, sourceAuthority);
                if (!(yield this.accountExists(source))) {
                    throw new Error("Source account does not exist");
                }
            }
            if (!destination) {
                if (isNative) {
                    ...
                    destination = yield spl_token_1.Token.getAssociatedTokenAddress(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, tokenBondingAcct.baseMint, sourceAuthority);
                    if (!(yield this.accountExists(destination))) {
     ...
     * @returns
     */
    closeInstructions({ tokenBonding, refund = this.wallet.publicKey, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const tokenBondingAcct = (yield this.getTokenBonding(tokenBonding));
            if (!tokenBondingAcct.generalAuthority) {
     ...
     * @returns
     */
    transferReservesInstructions({ tokenBonding, destination, amount, payer = this.wallet.publicKey, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const tokenBondingAcct = (yield this.getTokenBonding(tokenBonding));
            const state = (yield this.getState());
            const isNative = tokenBondingAcct.baseMint.equals(spl_token_1.NATIVE_MINT) ||
            ...
            if (!destination) {
                if (isNative) {
                    ...
                    destination = yield spl_token_1.Token.getAssociatedTokenAddress(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, tokenBondingAcct.baseMint, this.wallet.publicKey);
                }
            }
            ...
            if (!isNative &&
                ...
                const ataDestination = yield spl_token_1.Token.getAssociatedTokenAddress(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, tokenBondingAcct.baseMint, destination);
