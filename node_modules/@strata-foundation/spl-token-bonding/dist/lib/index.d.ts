...
export declare class SplTokenBonding extends AnchorSdk<SplTokenBondingIDL> {
     ...
     * @returns
     */
    createTokenBondingInstructions({ generalAuthority, curveAuthority, reserveAuthority, payer, curve, baseMint, targetMint, buyBaseRoyalties, buyBaseRoyaltiesOwner, buyTargetRoyalties, buyTargetRoyaltiesOwner, sellBaseRoyalties, sellBaseRoyaltiesOwner, sellTargetRoyalties, sellTargetRoyaltiesOwner, buyBaseRoyaltyPercentage, buyTargetRoyaltyPercentage, sellBaseRoyaltyPercentage, sellTargetRoyaltyPercentage, mintCap, purchaseCap, goLiveDate, // 10 secs ago
    freezeBuyDate, targetMintDecimals, targetMintKeypair, buyFrozen, ignoreExternalReserveChanges, ignoreExternalSupplyChanges, sellFrozen, index, advanced }: ICreateTokenBondingArgs): Promise<InstructionResult<ICreateTokenBondingOutput>>;
    /**
     ...
     * @param param0
     */
    swap({ payer, sourceAuthority, baseMint, targetMint, baseAmount, expectedBaseAmount, desiredTargetAmount, expectedOutputAmount, slippage, extraInstructions, }: ISwapArgs): Promise<{
        targetAmount: number;
    }>;
     ...
     * @returns
     */
    closeInstructions({ tokenBonding, refund, }: ICloseArgs): Promise<InstructionResult<null>>;
    /**
     ...
     * @returns
     */
    transferReservesInstructions({ tokenBonding, destination, amount, payer, }: ITransferReservesArgs): Promise<InstructionResult<null>>;
    /**
     * Runs {@link closeInstructions}
     * @param args
     */
