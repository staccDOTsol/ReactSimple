        ...
        try {
            return [
                ...(yield promiseAllInOrder(txns.map((txn) => () => __awaiter(this, void 0, void 0, function* () {
                    var _a, _b;
                    const txid = yield provider.connection.sendRawTransaction(txn, {
                        skipPreflight: true,
                    });
                    const result = yield provider.connection.confirmTransaction(txid, "confirmed");
                    if (result.value.err) {
                        const tx = yield provider.connection.getTransaction(txid, {
            ...
            const wrappedE = spl_utils_1.ProgramError.parse(e, errors);
