...
export declare function getClaimedTokenRefKeyForName(cache: AccountFetchCache, handle: string, mint: PublicKey | null | undefined, tld: PublicKey): Promise<PublicKey | undefined>;
 ...
 * @returns
 */
export declare function useSocialTokenMetadata(owner: PublicKey | undefined | null): IUseSocialTokenMetadataResult;
