...
class SplTokenMetadata {
    ...
    getTokenMetadata(metadataKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const displayName = (metadata === null || metadata === void 0 ? void 0 : metadata.data.name.length) == 32
                ? data === null || data === void 0 ? void 0 : data.name
                : metadata === null || metadata === void 0 ? void 0 : metadata.data.name;
    ...
    updateMetadataInstructions({ data, newAuthority, metadata, updateAuthority }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const instructions = new mpl_token_metadata_1.UpdateMetadataV2({}, {
                metadata,
                metadataData: data ? new mpl_token_metadata_1.DataV2(Object.assign({}, data)) : new mpl_token_metadata_1.DataV2(Object.assign(Object.assign({}, metadataAcct.data), { collection: metadataAcct === null || metadataAcct === void 0 ? void 0 : metadataAcct.collection, uses: metadataAcct === null || metadataAcct === void 0 ? void 0 : metadataAcct.uses })),
                updateAuthority: updateAuthority || new web3_js_1.PublicKey(metadataAcct.updateAuthority),
                newUpdateAuthority: typeof newAuthority == "undefined" ? new web3_js_1.PublicKey(metadataAcct.updateAuthority) : (newAuthority || undefined),
