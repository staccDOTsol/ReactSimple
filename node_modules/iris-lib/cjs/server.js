...
var Iris = void 0; /* jshint esversion: 9 */
...
var fsExists = (0, _util.promisify)(_fs.exists);
var fsMkdir = (0, _util.promisify)(_fs.mkdir);
var fsReadFile = (0, _util.promisify)(_fs.readFile);
...
(async function () {
  ...
  // Instantiate gun
  debug(gunConfig);
  var gun = new _gun2.default(gunConfig);
