...
var TextNode = function (_Component) {
  ...
  TextNode.prototype.componentDidMount = function componentDidMount() {
    ...
    var ps = _util2.default.getPublicState();
    ...
    if (myPub) {
      ...
      _Key2.default.getDefault().then(function (key) {
        setMyPub(key.pub);
      });
    }
  };
  ...
  TextNode.prototype.getNode = function getNode(user) {
    var base = _util2.default.getPublicState().user(user);
  ...
  TextNode.prototype.renderInput = function renderInput() {
    ...
    return (0, _preact2.html)(_templateObject, this.state.value, this.props.placeholder || this.path, this.getClass(), function (e) {
  ...
  TextNode.prototype.renderTag = function renderTag() {
    ...
    return (0, _preact2.html)(_templateObject2, tag, this.state.class, this.ref, this.isEditable(), placeholder, function (e) {
...
!_util2.default.isNode && (0, _preactCustomElement2.default)(TextNode, 'iris-text', ['path', 'user', 'placeholder', 'editable', 'tag']);
