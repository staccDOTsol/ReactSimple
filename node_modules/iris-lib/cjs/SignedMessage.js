...
var SignedMessage = function () {
  ...
  SignedMessage._getArray = function _getArray(authorOrRecipient) {
    ...
    for (var i = 0; i < keys.length; i++) {
      ...
      if (typeof value === 'string') {
        arr.push(new _Attribute2.default(type, value));
      } else {
        // array
        for (var j = 0; j < value.length; j++) {
          var elementValue = value[j];
          arr.push(new _Attribute2.default(type, elementValue));
        }
      }
    }
    return arr;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              _context.next = 8;
              return new _Attribute2.default(type, value);
            ...
            case 11:
              ...
              _context.next = 15;
              return new _Attribute2.default(type, elementValue);
  ...
  */
  ...
  SignedMessage.prototype.sign = async function sign(key) {
    this.sig = await _Key2.default.sign(this.signedData, key);
    this.pubKey = key.pub;
    await this.getHash();
    return true;
  };
  ...
  */
  ...
  SignedMessage.create = async function create(signedData, signingKey) {
    if (!signedData.author && signingKey) {
      signedData.author = { keyID: _Key2.default.getId(signingKey) };
    }
  ...
  */
  ...
  SignedMessage.prototype.getHash = async function getHash() {
    if (this.sig && !this.hash) {
      this.hash = await _util2.default.getHash(this.sig);
    }
    return this.hash;
  };
  ...
  SignedMessage.fromSig = async function fromSig(obj) {
    ...
    var signedData = await _Key2.default.verify(obj.sig, obj.pubKey);
  ...
  */
  ...
  SignedMessage.prototype.verify = async function verify() {
    ...
    this.signedData = await _Key2.default.verify(this.sig, this.pubKey);
    if (!this.signedData) {
      throw new ValidationError(errorMsg + ' Invalid signature');
    }
    if (this.hash) {
      if (this.hash !== (await _util2.default.getHash(this.sig))) {
