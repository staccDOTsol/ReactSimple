...
var ShallowRenderer = /** @class */ (function () {
    function ShallowRenderer() {
        this._mountRenderer = new MountRenderer_js_1.default();
    }
    ShallowRenderer.prototype.render = function (el, context, options) {
        ...
        // to a stub.
        compat_js_1.childElements(el).forEach(function (el) {
            if (el != null && typeof el !== 'string') {
                shallow_render_utils_js_1.shallowRenderVNodeTree(el);
            }
        });
        // Make any new elements rendered by the root element render to a stub.
        shallow_render_utils_js_1.withShallowRendering(function () {
